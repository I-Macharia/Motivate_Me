...
export class IPFSService {
    ...
    generateQuoteMetadata(quote: string, author: string, tags: string[], imageCID?: string): Record<string, any> {
        return {
            quote,
            author,
            tags,
    ...
    async uploadQuoteMetadata(metadata: Record<string, any>): Promise<string> {
        try {
            ...
            console.error('Error uploading quote metadata to IPFS:', error);
            throw error;
        }
    }
